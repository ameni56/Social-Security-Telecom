 ...
 */
final class Version20220724184331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_aide ADD type LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', DROP formulaire_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_aide ADD formulaire_id INT DEFAULT NULL, DROP type');
